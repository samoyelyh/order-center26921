...
from app.db.models import Asset, OrderBuyerAsset, OrderImportBatch, OrderImportBatchItem, OrderItem
...
from app.services.repository import find_asset_by_blake3, new_id, utcnow
...
def _ensure_asset(db: Session, filename: str, data: bytes, actor: str) -> Asset:
    digest = compute_blake3(data)
    existing = find_asset_by_blake3(db, digest)
